...
export function SiteHeader() { 
  return (
    <header className="border-b border-border/80 bg-background/80 backdrop-blur-md sticky top-0 z-40">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
        <Link href="/" className="flex items-center gap-2.5 font-mono text-xs sm:text-sm font-bold tracking-[0.2em] text-foreground transition-colors hover:text-accent">
          <Eye size={16} className="text-accent" /> 
          <span>GHOSTFILTER</span>
        </Link>
